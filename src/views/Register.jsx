...
import { Box, Icon, TextField, useMediaQuery, useTheme } from '@mui/material'
  ...
  const handleSubmit = async event => {
    ...
    if (validateFields()) {
      try {
        ...
        toastDisplayer('error', 'There was an error with the registration.')
      }
    } else {
          ...
          <div className='flex flex-col gap-6'>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
              ...
              {activeStep < steps.length - 1 ? (
                <Button variant='contained' type='button' onClick={handleComplete}>
                  Next
                </Button>
              ) : (
